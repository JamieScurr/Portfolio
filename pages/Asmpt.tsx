...
const Asmpt = (props: Props) => {
	return (
		<div className="relative py-10 px-8 min-h-screen w-screen justify-center mx-auto flex flex-wrap items-center  overflow-hidden">
			<div className="max-w-screen-xl  sm:grid sm:grid-cols-2 sm:mx-auto sm:gap-10 sm:p-5">
				<div className="flex flex-col">
					...
					<div className="mt-8 hidden sm:flex sm:flex-wrap">
						<h2 className=" decoration-[--green] decoration-2 mb-1 mt-8 sm:mt-0 sm:text-xl sm:pt-0 font-semibold  ">
							Technical Skills
							<span className="text-[--green] font-black">:</span>
						</h2>
						<div>
							<ul className="mt-8 max-w-screen-lg gap-x-8 xl:gap-y-24 gap-y-12 md:gap-y-16 md:gap-28 md:text-lg  text-center items-left justify-start  text-xs align-middle flex flex-wrap sm:justify-start ">
